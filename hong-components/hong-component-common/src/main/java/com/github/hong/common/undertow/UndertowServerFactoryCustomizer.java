package com.github.hong.common.undertow;
 ...
 * <p>
 * 解决启动时警告：[io.undertow.websockets.jsr.handleDeployment:68] -->
    ...
    public void customize(UndertowServletWebServerFactory factory) {
        UndertowDeploymentInfoCustomizer undertowDeploymentInfoCustomizer = deploymentInfo -> {
            WebSocketDeploymentInfo webSocketDeploymentInfo =
                    (WebSocketDeploymentInfo) deploymentInfo.getServletContextAttributes().get(WebSocketDeploymentInfo.ATTRIBUTE_NAME);
