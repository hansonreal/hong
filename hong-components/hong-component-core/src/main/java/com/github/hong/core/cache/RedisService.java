package com.github.hong.core.cache;
...
public class RedisService {
    ...
    private static final RedisTemplate getStringRedisTemplate() {
        ...
        if (stringRedisTemplate == null) {
            ...
            if (SpringBeanUtil.getApplicationContext().containsBean("defaultStringRedisTemplate")) {
                stringRedisTemplate = SpringBeanUtil.getBean("defaultStringRedisTemplate", StringRedisTemplate.class);
            } else {
